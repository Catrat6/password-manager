...
button_encrypt = Button(text='Encrypt/Decrypt Data', bg=GRAY, fg=BLACK, font=('Ariel', 18), command=encrypt.encrypt_decrypt)
...
def open_window():
    global pg
    generator_window = tkinter.Toplevel(window)
    ...
    label = Label(generator_window, text='Generate a random password', fg=NEON_GREEN, bg='black', font=('Ariel', 14, 'bold'))
    label.grid(column=0, row=0, columnspan=3)

    label = Label(generator_window, text='Check Your preferred method and enter the length', fg=NEON_GREEN, bg='black', font=('Ariel', 14, 'bold'))
    label.grid(column=0, row=1, columnspan=3)

    toggle_one = Checkbutton(generator_window, text='Random', fg=NEON_PURPLE, bg='black', font=('Arial', 12, 'bold'), variable=switch_one)
    ...
    toggle_two = Checkbutton(generator_window, text='Phrase/words', fg=NEON_PURPLE, bg='black', font=('Arial', 12, 'bold'), variable=switch_two)
    ...
    button_gen_new_pass = Button(generator_window, text='Generate', width=32, bg=GRAY, fg=BLACK, command=generate_random)
